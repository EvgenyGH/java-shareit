...
import ru.practicum.shareitserver.item.exception.ItemException;
import ru.practicum.shareitserver.item.exception.ItemNotFoundException;
import ru.practicum.shareitserver.user.exception.UserException;
...
@RestControllerAdvice({"ru.practicum.shareitserver.item"})
@Slf4j
